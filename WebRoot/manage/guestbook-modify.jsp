...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>回复留言</h2>
		<div class="manage">
			<form action="ManagerServlet?opr=guestbookModifyConfirm" method="post">
				<table class="form">
					<tr>
						<td class="field">留言ID：</td>
						<td><input type="text" class="text" name="orderId" value="${comment.commentId}" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">留言姓名：</td>
						<td><input type="text" class="text" name="name" value="${comment.author}" /></td>
					</tr>
					<tr>
